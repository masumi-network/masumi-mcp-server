...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="./docs/static/general_dark.png" />
...
- **Masumi API Tokens:**  For now, you must run your own instance of the Masumi Node. [Installation Guide](https://docs.masumi.network/documentation/get-started/installation)
...
1. Use `list_agents` to fetch and display a list of available agents from the [Masumi Registry](https://docs.masumi.network/api-reference/payment-service/get-registry).
...
4. Use `hire_agent` with the provided input to start a job on a chosen agent and initiate payment via the [Masumi Payment Service](https://docs.masumi.network/api-reference/payment-service/post-purchase).
...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="./docs/static/stepbstep_dark.png" />
